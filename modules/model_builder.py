...
def ccbm_tenas_derm7(params,
    ...
    #tenas_derm7 = Network(args.init_channels, CIFAR_CLASSES, args.layers, args.auxiliary, genotype)
    return 0
...
def get_ccbm_model(model_name: str,
    ...
    if model_name == "vgg16":
        ...
        model = ccbm_tenas_derm7(params=params,
                                class_ind_vec=class_ind_vec,
                                device=device,
                                freeze_layers=freeze_layers,
                                train_classifier=train_classifier
