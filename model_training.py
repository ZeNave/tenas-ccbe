...
#models = ["resnet18", "resnet50", "resnet101", "vgg16", "mobilenetv2", "densenet201", "seresnext", "tenas_derm7", "resnet101", "r18", "r152"]
models = ["r152"]
...
for dataloader_name, (train_dataloader, val_dataloader, dataset_params) in dataloaders.items():
    ...
    for i, model_name in enumerate(models):
        ...
        if model_name in ["mobilenetv2", "r18", "r152"] :
            OUT_DIM = 49
        elif model_name == "tenas_derm7":
            OUT_DIM = 3136
        else:
            OUT_DIM = 196
        ...
        _, model_3 = engine.train(model=model,
                     train_dataloader=train_dataloader,
                     val_dataloader=val_dataloader,
                     optimizer_s_loss=optimizer_s_loss,
                     optimizer_classification_loss=optimizer_classification_loss,
