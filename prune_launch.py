...
TORCH_HOME = "/home/socialab/Desktop/zenave/PhD/torch_home"  # Path that contains the nas-bench-201 database. If you only want to run on NASNET (i.e. DARTS) search space, then just leave it empty
data_paths = {
    "cifar10": "./",
    "cifar100": "./",
    "derm7":"./"
...
parser.add_argument('--dataset', default='cifar100', type=str, choices=['cifar10', 'cifar100', 'ImageNet16-120', 'imagenet-1k','derm7'], help='Choose between cifar10/100/ImageNet16-120/imagenet-1k')
